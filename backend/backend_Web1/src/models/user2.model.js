...
const userSchema2 = new mongoose.Schema(
  {
    ...
    // ✅ FIX: uploadProfileImage/removeProfileImage (client, SMM, GD)
    // controllers ye field set karte the (user.profileImagePublicId = ...)
    // lekin schema me field hi define nahi tha — Mongoose strict mode
    // isse silently DROP kar deta tha save ke time. Isliye purani
    // Cloudinary image kabhi delete nahi hoti thi (orphaned upload) aur
    // dobara login/refresh pe field hamesha undefined milta tha.
