...
facebook: {
  ...
  // access" hi kyun na diya ho. Isi wajah se "No Facebook Page found"
  // aata tha.
  // FIX v24: "read_insights" add kiya — bina iske Facebook post ke
  // reach/impressions/video-views (jo /insights endpoint se aate hain)
  // kabhi fetch nahi ho paate the, sirf likes/comments/shares hi milte
  // the (jo pages_read_engagement se hi mil jaate hain). Reach/views
  // hamesha 0 aa rahe the isi wajah se.
  scope: "public_profile,pages_show_list,pages_manage_posts,pages_read_engagement,business_management,read_insights",
  version: "v18.0"
},
